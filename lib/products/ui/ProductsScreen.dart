...
class ProductScreen extends StatelessWidget {
  final controller = Get.put(ProductsController());  //initialization of GetX ProductController
  final product = Product(
      id: 1,
      description: "Description",
      imageLink: "https://upload.wikimedia.org/wikipedia/commons/1/17/Google-flutter-logo.png",
      name: "Maybelline",
      price: "32");
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Obx(
          () => controller.isLoading.value  //if isLoading is True then show Shimmer effect else show Product List
              ? GridView.builder(
